...
describe("verify-local-db-contract", () => {
  ...
  it("reports exact failing contract items", () => {
    ...
    expect(result.failures).toEqual([
      ...
      "missing table: strategy_intents",
      "missing table: posture_overrides",
      "missing column: assets.rated_max_power_kw",
      "missing column: assets.rated_max_current_a",
      "missing column: assets.rated_min_power_kw",
      "missing column: assets.rated_min_current_a",
      ...
      "missing column: device_command_logs.batch_id",
      "missing column: device_command_logs.source",
