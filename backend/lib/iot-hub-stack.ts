...
export class IotHubStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: IotHubStackProps) {
    ...
    const handlersDir = path.join(__dirname, '..', 'src', 'iot-hub', 'handlers');
    ...
    const ingestTelemetryFn = new nodejs.NodejsFunction(this, 'IngestTelemetry', {
    ...
    const scheduleToShadowFn = new nodejs.NodejsFunction(this, 'ScheduleToShadow', {
      runtime: lambda.Runtime.NODEJS_18_X,
