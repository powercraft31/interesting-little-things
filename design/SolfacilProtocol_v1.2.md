...
- 网关收到 `device/ems/{clientId}/subDevices/get` 请求后，应按当前已知的子设备列表，发送 `device/ems/{clientId}/deviceList` 消息；
...
| grid_factorA               | string | 并网侧 A 相功率因数       |
| grid_factorB               | string | 并网侧 B 相功率因数       |
| grid_factorC               | string | 并网侧 C 相功率因数       |
| grid_frequency             | string | 电网频率 (Hz)             |
| grid_totalSellEnergy       | string | 累计卖电电量              |
| grid_totalBuyEnergy        | string | 累计买电电量              |
| grid_totalSellActiveEnergy | string | 累计卖电有功电量          |
| grid_totalBuyActiveEnergy  | string | 累计买电有功电量          |
