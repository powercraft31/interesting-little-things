...
| 01 | **SHARED_LAYER** | [01_SHARED_LAYER_v5.4.md](./01_SHARED_LAYER_v5.4.md) | 公共型別定義、API 契約、EventSchema、目錄結構 |
...
所有模組的輸入規格（Request Schema）與輸出規格（Response / Event Payload），均定義於 [`01_SHARED_LAYER_v5.4.md`](./01_SHARED_LAYER_v5.4.md)，一旦版本發佈，視同**鎖死的硬體腳位**，不得單方面修改。
...
|---------|---------|---------|------|---------|
| Shared | Shared Layer | **v5.4** | [01_SHARED_LAYER](./01_SHARED_LAYER_v5.4.md) | 公共型別、Connection Pool |
