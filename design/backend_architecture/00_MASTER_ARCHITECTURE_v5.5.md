...
| # | 文件名 | 路徑 | 說明 |
|---|--------|------|------|
| 00 | **MASTER_ARCHITECTURE** | `00_MASTER_ARCHITECTURE_v5.5.md` | 系統總控藍圖（本文件） |
| M1 | **IOT_HUB_MODULE** | [01_IOT_HUB_MODULE_v5.3.md](./01_IOT_HUB_MODULE_v5.3.md) | IoT Hub — MQTT 接入、動態解析器、Asset Shadow |
| M2 | **OPTIMIZATION_ENGINE_MODULE** | [02_OPTIMIZATION_ENGINE_MODULE_v5.5.md](./02_OPTIMIZATION_ENGINE_MODULE_v5.5.md) | Optimization Engine — 4 種策略演算法、排程最佳化、雙目標框架 |
| M3 | **DR_DISPATCHER_MODULE** | [03_DR_DISPATCHER_MODULE_v5.2.md](./03_DR_DISPATCHER_MODULE_v5.2.md) | DR Dispatcher — 調度指令、SQS 逾時、狀態追蹤 |
| M4 | **MARKET_BILLING_MODULE** | [04_MARKET_BILLING_MODULE_v5.5.md](./04_MARKET_BILLING_MODULE_v5.5.md) | Market & Billing — 電價計費、雙軌收益計算、PostgreSQL schema |
...
| M2 | Optimization Engine | **v5.5** | [02_OPTIMIZATION_ENGINE](./02_OPTIMIZATION_ENGINE_MODULE_v5.5.md) | Lambda + AppConfig |
| M3 | DR Dispatcher | v5.2 | [03_DR_DISPATCHER](./03_DR_DISPATCHER_MODULE_v5.2.md) | Lambda + EventBridge + MQTT |
| M4 | Market & Billing | **v5.5** | [04_MARKET_BILLING](./04_MARKET_BILLING_MODULE_v5.5.md) | Lambda + DynamoDB |
