...
> **最後更新**: 2026-02-28
> **說明**: 4 種策略演算法、AppConfig Strategy Profiles、成本最佳化、SOC 約束、排程輸出、雙目標最佳化框架、Schedule Generator Cron Job、動態電價優先策略
...
│   ├── schedule-generator.ts     # v5.6: Cron Job — Mock rule-based 排程生成
...
└── __tests__/
    ...
    ├── schedule-generator.test.ts     # v5.6
