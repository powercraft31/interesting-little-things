...
| # | 文件名 | 路徑 | 說明 |
|---|--------|------|------|
| 00 | **MASTER_ARCHITECTURE** | `00_MASTER_ARCHITECTURE_v5.6.md` | 系統總控藍圖（本文件） |
| M1 | **IOT_HUB_MODULE** | [01_IOT_HUB_MODULE_v5.3.md](./01_IOT_HUB_MODULE_v5.3.md) | IoT Hub — MQTT 接入、動態解析器、Asset Shadow |
| M2 | **OPTIMIZATION_ENGINE_MODULE** | [02_OPTIMIZATION_ENGINE_MODULE_v5.6.md](./02_OPTIMIZATION_ENGINE_MODULE_v5.6.md) | Optimization Engine — 4 種策略演算法、排程最佳化、雙目標框架、Schedule Generator Cron Job |
...
| M7 | **OPEN_API_MODULE** | [07_OPEN_API_MODULE_v5.2.md](./07_OPEN_API_MODULE_v5.2.md) | Open API — M2M Gateway、Webhook、WAF、Rate Limiting |
...
| 10 | **DATABASE_SCHEMA** | [10_DATABASE_SCHEMA_v5.5.md](./10_DATABASE_SCHEMA_v5.5.md) | PostgreSQL 完整 DDL — 18 張表、ER 圖、Migration 管理 |
...
| Shared | Database Schema | **v5.5** | [10_DATABASE_SCHEMA](./10_DATABASE_SCHEMA_v5.5.md) | PostgreSQL — 18 張表 |
| M1 | IoT Hub | **v5.3** | [01_IOT_HUB](./01_IOT_HUB_MODULE_v5.3.md) | Lambda + IoT Core + DynamoDB |
| M2 | Optimization Engine | **v5.6** | [02_OPTIMIZATION_ENGINE](./02_OPTIMIZATION_ENGINE_MODULE_v5.6.md) | Lambda + AppConfig |
...
| M7 | Open API | v5.2 | [07_OPEN_API](./07_OPEN_API_MODULE_v5.2.md) | Lambda + API Gateway |
...
| 外部數據 | 電價表、天氣快取、CCEE PLD 電價入 DB，不依賴外部 API 即時請求 |
...
| **pld_horario** | M4 Market & Billing | 參考表 | **v5.5** — CCEE 批發市場每小時電價 |
...
> 詳細 DDL 請見：`design/backend_architecture/10_DATABASE_SCHEMA_v5.5.md`
