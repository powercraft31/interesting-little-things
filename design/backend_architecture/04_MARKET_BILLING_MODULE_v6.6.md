# M4: 市場與計費模組 — v6.6 完整技術參考

> **模組版本**: v6.6
> **Git HEAD**: `4ec191a`
> **上層文件**: [00_MASTER_ARCHITECTURE_v6.6.md](./00_MASTER_ARCHITECTURE_v6.6.md)
> **前版**: [04_MARKET_BILLING_MODULE_v5.24.md](./_archive/04_MARKET_BILLING_MODULE_v5.24.md)
> **最後更新**: 2026-03-31
> **說明**: v6.6 完整模組參考文件 — 整合電價查詢、利潤計算、每日計費批次、收入模型、自消費/自給率、P3 節省公式
...
**v5.24 → v6.6：`runDailyPsSavings` SQL 別名修正 + 文件升級為完整技術參考。**
